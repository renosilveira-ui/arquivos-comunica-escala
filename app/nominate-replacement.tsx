  ...
  return (
    <ScreenGradient variant="light">
      <View style={{ flex: 1, paddingHorizontal: 20, paddingTop: 20 }}>
        ...
        >
          Selecione o profissional que assumirá seu plantão. Ele receberá uma
        ...
        <PrimaryButton
          label={
            nominateMutation.isPending ? "Enviando..." : "Indicar substituto"
          }
          icon={<UserPlus size={20} color="#FFFFFF" />}
          onPress={handleNominate}
          disabled={!selectedProfessional || nominateMutation.isPending}
