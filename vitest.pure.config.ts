...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "tests/agenda-list-error-state.test.ts",
      "tests/my-offers-operational-state.test.ts",
      ...
      "tests/post-login-redirect.test.ts",
      ...
      "tests/swap-segment-count-fence.test.ts",
      ...
      "tests/whatsapp-verification-source.test.ts",
      "tests/whatsapp-verification-provider.test.ts",
      "tests/whatsapp-verification-rate-limit.test.ts",
      ...
      "tests/form-masks-br.test.ts",
      "tests/personal-calendar-domain.test.ts",
      "tests/personal-calendar-window-contract.test.ts",
      ...
      "tests/external-credentials-crypto.test.ts",
      ...
      "tests/manual-migration-superseded-guard.test.ts",
