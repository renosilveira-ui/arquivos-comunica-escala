...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "tests/schedule-invites-operational-revision-migration.test.ts",
      "tests/schedule-invite-operational-events.test.ts",
      "tests/schedule-invite-operational-contract.test.ts",
      "tests/schedule-invite-operational-wiring.test.ts",
