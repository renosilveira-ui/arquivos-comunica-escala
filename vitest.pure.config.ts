...
export default defineConfig({
  ...
  test: {
    ...
    setupFiles: [],
    include: [
      "tests/audit-movements-privacy.test.ts",
      ...
      "tests/open-month-capacity-paused.test.ts",
      ...
      "tests/professional-identity-fence.test.ts",
      ...
      "tests/swap-list-read-batch.test.ts",
      ...
      "tests/vacancy-read-bounds-source.test.ts",
