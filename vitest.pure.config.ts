...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "tests/agenda-month-visual-signals.test.ts",
      ...
      "tests/personal-agenda-presentation.test.ts",
      "tests/personal-agenda-editor-state.test.ts",
      "tests/personal-agenda-editor-ui.test.ts",
